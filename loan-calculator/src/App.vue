  ...
  v-app.loan-calc
    ...
    v-container
      ...
      v-flex.text-xs-center.my-5( xs12, md8, offset-md2 )
          h3.display-1
            | Calculate a loan secured by a car right now!
          ...
          v-layout( row, wrap )
            ...
            v-flex.text-xs-right.blue.darken-1.white--text.loan-calc--vert.hidden-sm-and-down( xs12, md4 )
              h4.white--text.mb-0.pr-2
                | car bomber
              p.mb-0.pr-2
                | the car remains in our parking lot
            // center column
  ...
  export default {
    ...
    filters: {
      ...
      currency (value) {
        ...
        return value.toLocaleString('sg-SG', { style: 'currency', currency: 'SGD', maximumSignificantDigits: 4 })
      }
    },
    data () {
      return {
